...
func GetVolumeMountMap(mounts []api.VolumeMount) map[string]string {
...
func GetVolumeDeviceMap(devices []api.VolumeDevice) map[string]string {
...
func ValidateVolumeMounts(mounts []api.VolumeMount, voldevices map[string]string, volumes map[string]api.VolumeSource, container *api.Container, fldPath *field.Path) field.ErrorList {
	allErrs := field.ErrorList{}
...
func ValidateVolumeDevices(devices []api.VolumeDevice, volmounts map[string]string, volumes map[string]api.VolumeSource, fldPath *field.Path) field.ErrorList {
	allErrs := field.ErrorList{}
...
func validateContainers(containers []api.Container, volumes map[string]api.VolumeSource, fldPath *field.Path) field.ErrorList {
	allErrs := field.ErrorList{}
